...
<body>
<form action="prodBuy" method="post">
<table width="800" border="1">
	<c:set var="total" value="0"/>
	<tr><td>이미지</td><td>상품명</td><td>수량</td><td>단가</td><td>적용금액</td></tr>
<c:forEach items="${list}" var="productCartDTO">
	<tr><td><input type="checkbox" value="${productCartDTO.cartDTO.prodNo}" name="prodCk" onchange="prodChk();" checked/>
		...
		<td align="center">
			<a href="javascript:checkQty('${productCartDTO.cartDTO.cartQty}',
										 ...
										 '${productCartDTO.productDTO.prodPrice}');">-</a>
			&nbsp;&nbsp;&nbsp; ${productCartDTO.cartDTO.cartQty} &nbsp;&nbsp;&nbsp;
			<a href="cartAdd?prodNo=${productCartDTO.cartDTO.prodNo}&cartQty=1&prodPrice=${productCartDTO.productDTO.prodPrice}&catNum=0">+</a>
		</td>
