...
<c:forEach items="${list}" var="productCartDTO">
	<tr><td><img src="../product/upload/${productCartDTO.productDTO.prodImage.split(',')[0]}"/></td>
		<td>${productCartDTO.productDTO.prodName}<br/>
			단가 : ${productCartDTO.productDTO.prodPrice} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			${productCartDTO.cartDTO.cartQty}개
		</td>
		<td align="right">${total + productCartDTO.cartDTO.cartPrice}원</td>
	</tr>
...
<table width="800">
	<tr><th>배송지 주소</th><td><input type="text" name="purchAddr"/></td></tr>
	<tr><th>받는 사람</th><td><input type="text" name="purchReceiver"/></td></tr>
	<tr><th>연락처</th><td><input type="text" name="purchPhoneNumber"/></td></tr>
	<tr><th>주문 문자</th><td><input type="text" name="purchMsg"/></td></tr>
